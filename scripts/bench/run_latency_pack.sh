...
BENCH_DIR="$ROOT_DIR/benchmarks/configs/latency"
...
| Config | Path |
|--------|------|
| Steady State | benchmarks/configs/latency/steady_state.toml |
| Overload Ramp | benchmarks/configs/latency/overload_ramp.toml |
| GC Stress | benchmarks/configs/latency/gc_stress.toml |
| Cross-Shard | benchmarks/configs/latency/cross_shard.toml |
