...
fn segment_filename(segment_id: u64) -> String {
    format!("cedar_{:06}.wal", segment_id)
}
...
impl WalWriter {
    ...
    pub fn open_with_options(
        ...
        // Also handle legacy single-file WAL (cedar.wal)
        let legacy_path = dir.join("cedar.wal");
...
impl WalReader {
    ...
    pub fn read_all(&self) -> Result<Vec<WalRecord>, StorageError> {
        ...
        let legacy_path = self.dir.join("cedar.wal");
...
pub type CheckpointTableRows = Vec<(Vec<u8>, cedar_common::datum::OwnedRow)>;
...
pub struct CheckpointData {
    ...
    pub catalog: cedar_common::schema::Catalog,
