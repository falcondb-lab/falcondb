...
use cedar_common::types::{NodeId, ShardId};
...
impl HAReplicaGroup {
    ...
    pub fn catch_up_all_replicas(&self) -> Result<usize, CedarError> {
        let mut total = 0;
    ...
    pub fn promote_best(&mut self) -> Result<usize, CedarError> {
        // Cooldown check
        {
    ...
    pub fn add_replica(&mut self, schemas: &[TableSchema]) -> Result<usize, CedarError> {
    ...
    pub fn remove_replica(&mut self, replica_idx: usize) -> Result<(), CedarError> {
...
impl FailoverOrchestrator {
    ...
    pub fn start(
        ...
        let join_handle = std::thread::Builder::new()
            .name("cedar-failover-orchestrator".to_string())
            .spawn(move || {
