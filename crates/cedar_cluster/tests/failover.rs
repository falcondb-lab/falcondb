//! Cedar M1 Failover Exercise 鈥?integration test.
//!
...
//!
//! Run:  cargo test -p cedar_cluster --test failover -- --ignored
...
#[test]
#[ignore] // Run explicitly: cargo test -p cedar_cluster --test failover -- --ignored
