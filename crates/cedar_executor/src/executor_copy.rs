...
impl Executor {
    ...
    pub fn exec_copy_from_data(
        ...
        let text = String::from_utf8(data.to_vec())
            .map_err(|e| CedarError::Execution(ExecutionError::TypeError(
    ...
    pub fn exec_copy_query_to(
        &self,
        query_plan: &cedar_planner::PhysicalPlan,
        csv: bool,
        delimiter: char,
        header: bool,
        null_string: &str,
        ...
        let (columns, rows) = match inner_result {
            ...
            _ => return Err(CedarError::Internal("COPY (query) inner plan did not return Query result".into())),
        };
