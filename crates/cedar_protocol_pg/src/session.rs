...
use cedar_common::types::{DataType, IsolationLevel, TableId};
use cedar_common::schema::TableSchema;
use cedar_common::tenant::{TenantId, SYSTEM_TENANT_ID};
use cedar_common::security::{RoleId, SUPERUSER_ROLE_ID, TxnPriority};
...
pub struct CursorState {
    ...
    pub rows: Vec<cedar_common::datum::OwnedRow>,
    /// Column descriptors.
    pub columns: Vec<(String, cedar_common::types::DataType)>,
