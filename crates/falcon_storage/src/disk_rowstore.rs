...
mod tests {
    ...
    fn test_page_split_many_rows() {
        ...
        for i in [0, 50, 100, 150, 199] {
            let pk = crate::memtable::encode_pk(
                &OwnedRow::new(vec![Datum::Int64(i), Datum::Text(String::new().into())]),
                &[0],
            );
    ...
    fn test_range_scan() {
        ...
        let start = crate::memtable::encode_pk(
            &OwnedRow::new(vec![Datum::Int64(10), Datum::Text(String::new().into())]),
            &[0],
        );
        let end = crate::memtable::encode_pk(
            &OwnedRow::new(vec![Datum::Int64(20), Datum::Text(String::new().into())]),
            &[0],
        );
