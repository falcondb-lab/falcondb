...
fn try_extract_exists_semijoin(
    expr: &BoundExpr,
) -> Option<(cedar_common::types::TableId, cedar_common::schema::TableSchema, Vec<(usize, usize)>, bool)> {
...
fn try_extract_in_semijoin(
    expr: &BoundExpr,
) -> Option<(usize, cedar_common::types::TableId, cedar_common::schema::TableSchema, usize, bool)> {
