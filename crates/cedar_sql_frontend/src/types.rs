...
pub enum AlterTableOp {
    AddColumn(cedar_common::schema::ColumnDef),
    DropColumn(String),
    RenameColumn { old_name: String, new_name: String },
    RenameTable { new_name: String },
    AlterColumnType { column_name: String, new_type: cedar_common::types::DataType },
...
pub struct BoundSelect {
    ...
    pub virtual_rows: Vec<cedar_common::datum::OwnedRow>,
}
