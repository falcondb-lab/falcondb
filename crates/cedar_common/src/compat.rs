...
pub fn pg_compat_matrix() -> Vec<CompatEntry> {
    vec![
        CompatEntry {
            name: "psycopg2".into(), language: "Python".into(),
            version: "2.9+".into(), status: CompatStatus::Full,
            notes: "Standard PG wire protocol, full support.".into(),
        },
        CompatEntry {
            name: "psycopg3".into(), language: "Python".into(),
            version: "3.1+".into(), status: CompatStatus::Full,
            notes: "Extended query protocol supported.".into(),
        },
        CompatEntry {
            name: "asyncpg".into(), language: "Python".into(),
            version: "0.28+".into(), status: CompatStatus::Partial,
            notes: "Binary protocol partially supported.".into(),
        },
        CompatEntry {
            name: "JDBC (pgjdbc)".into(), language: "Java".into(),
            version: "42.6+".into(), status: CompatStatus::Full,
            notes: "Standard PG JDBC driver, full support.".into(),
        },
        CompatEntry {
            name: "node-postgres".into(), language: "JavaScript".into(),
            version: "8.11+".into(), status: CompatStatus::Full,
            notes: "Simple and extended query protocol.".into(),
        },
        CompatEntry {
            name: "go-pq".into(), language: "Go".into(),
            version: "1.10+".into(), status: CompatStatus::Full,
            notes: "Standard PG Go driver.".into(),
        },
        CompatEntry {
            name: "pgx".into(), language: "Go".into(),
            version: "5.4+".into(), status: CompatStatus::Partial,
            notes: "Extended query protocol, some type coercions pending.".into(),
        },
        CompatEntry {
            name: "sqlx".into(), language: "Rust".into(),
            version: "0.7+".into(), status: CompatStatus::Partial,
            notes: "Compile-time query checking requires pg_catalog support.".into(),
        },
        CompatEntry {
            name: "tokio-postgres".into(), language: "Rust".into(),
            version: "0.7+".into(), status: CompatStatus::Full,
            notes: "Async PG driver, full wire protocol support.".into(),
        },
        CompatEntry {
            name: "libpq (C)".into(), language: "C".into(),
            version: "15+".into(), status: CompatStatus::Full,
            notes: "Native PG client library.".into(),
        },
        // ORMs
        CompatEntry {
            name: "SQLAlchemy".into(), language: "Python".into(),
            version: "2.0+".into(), status: CompatStatus::Partial,
            notes: "Basic CRUD works. Advanced DDL introspection limited.".into(),
        },
        CompatEntry {
            name: "Django ORM".into(), language: "Python".into(),
            version: "4.2+".into(), status: CompatStatus::Partial,
            notes: "Migrations may require manual adaptation.".into(),
        },
        CompatEntry {
            name: "Hibernate".into(), language: "Java".into(),
            version: "6.2+".into(), status: CompatStatus::Partial,
            notes: "Use PostgreSQL dialect. Sequence generation may differ.".into(),
        },
        CompatEntry {
            name: "GORM".into(), language: "Go".into(),
            version: "2.0+".into(), status: CompatStatus::Partial,
...
impl BenchmarkReport {
    ...
    pub fn summary(&self) -> String {
        format!(
            ...
            self.workload, self.duration_secs, self.threads,
            self.ops_per_sec, self.p50_latency_us, self.p99_latency_us, self.errors,
        )
    }
}
